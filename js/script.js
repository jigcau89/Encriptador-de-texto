...
const decryptButton = document.getElementsByClassName("buttondecrypt")[0];
const copyButton = document.getElementsByClassName("button-copy")[0];
const resetButton = document.getElementsByClassName("button-reset")[0];
const messageContainer = document.getElementById("message");
const errorContainer = document.getElementById("error");
const responseContainer = document.getElementById("response");
const copyContainer = document.getElementById("button-copy");
